      ...
      <div className={styles.grid}>
        <div>
          <Reveal className="eyebrow">
            ...
            <span style={{ color: "rgba(212,168,83,0.85)" }}>Enquiries</span>
          </Reveal>
            ...
            <div className={styles.contactItem}>
              <div className={styles.contactIcon}>
                <svg width="15" height="13" viewBox="0 0 16 14" fill="none">
                  <rect x="1" y="1" width="14" height="12" rx="1" stroke="#7DAF88" strokeWidth="1" fill="none" />
                  <path d="M1 2.5 L8 8 L15 2.5" stroke="#7DAF88" strokeWidth="1" fill="none" />
                </svg>
              </div>
              <div>
              ...
              <div className={styles.contactIcon}>
                <svg width="13" height="16" viewBox="0 0 14 18" fill="none">
                  <path
                    ...
                    fill="none"
                  />
                  <circle cx="7" cy="6" r="2" stroke="#7DAF88" strokeWidth="1" fill="none" />
                </svg>
              </div>
              <div>
