...
export const metadata = {
  ...
  description:
    "Breathwork, sound bath meditation, energy healing and soul-led coaching delivered at your premises — evidence-based nervous system regulation for high-performing teams.",
};
...
const SERVICES = [
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <path d="M4 19 C4 19 10 9 19 9 C28 9 34 19 34 19 C34 19 28 29 19 29 C10 29 4 19 4 19Z" stroke="#7C9181" strokeWidth="1.4" fill="none" />
        <circle cx="19" cy="19" r="4" fill="#7C9181" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <circle cx="19" cy="19" r="4" fill="#7C9181" />
        <circle cx="19" cy="19" r="10" stroke="#7C9181" strokeWidth="1.2" fill="none" />
        <circle cx="19" cy="19" r="17" stroke="#7C9181" strokeWidth="0.6" fill="none" strokeDasharray="2 3" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <path d="M19 3 L22 16 L35 19 L22 22 L19 35 L16 22 L3 19 L16 16 Z" stroke="#7C9181" strokeWidth="1.2" fill="none" />
        <circle cx="19" cy="19" r="3" fill="#7C9181" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <path d="M7 13 Q7 7 13 7 L25 7 Q31 7 31 13 L31 21 Q31 27 25 27 L21 27 L15 34 L15 27 L13 27 Q7 27 7 21 Z" stroke="#7C9181" strokeWidth="1.2" fill="none" />
        <circle cx="19" cy="17" r="2.5" fill="#7C9181" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <circle cx="19" cy="19" r="13" stroke="#7C9181" strokeWidth="1.2" fill="none" />
        <path d="M19 8 L19 19 L27 19" stroke="#7C9181" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
        <path d="M4 32 L14 14 L19 22 L25 10 L34 32 Z" stroke="#7C9181" strokeWidth="1.2" fill="none" />
        <circle cx="25" cy="10" r="3" fill="#7C9181" />
      </svg>
    ),
  },
];
  ...
  return (
    <>
      ...
      <section className={styles.retreat}>
        ...
        >
          <rect width="1280" height="540" fill="#1c1c1b" />
          <rect width="1280" height="270" fill="#26302a" opacity="0.7" />
          <rect y="270" width="1280" height="270" fill="#161916" opacity="0.85" />
          <line x1="0" y1="270" x2="1280" y2="270" stroke="#7C9181" strokeWidth="0.5" opacity="0.28" />
          <path d="M0 270 Q200 155 380 270 Q540 168 720 270 Q900 138 1080 270 Q1180 172 1280 270" fill="#202824" opacity="0.82" />
          <path d="M0 312 Q320 302 640 312 Q960 322 1280 312" stroke="#7C9181" strokeWidth="0.5" fill="none" opacity="0.22" />
          <path d="M0 348 Q320 338 640 348 Q960 358 1280 348" stroke="#7C9181" strokeWidth="0.3" fill="none" opacity="0.15" />
