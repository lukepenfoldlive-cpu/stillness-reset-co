        ...
        >
          <defs>
            <pattern id="rp" x="0" y="0" width="300" height="300" patternUnits="userSpaceOnUse">
              <circle cx="150" cy="150" r="48" fill="none" stroke="#7C9181" strokeWidth="1" />
              <circle cx="150" cy="150" r="96" fill="none" stroke="#7C9181" strokeWidth="0.65" />
              <circle cx="150" cy="150" r="144" fill="none" stroke="#7C9181" strokeWidth="0.4" />
            </pattern>
            <radialGradient id="hg" cx="75%" cy="30%" r="55%">
              <stop offset="0%" stopColor="#7C9181" stopOpacity="0.3" />
              <stop offset="100%" stopColor="#1c1c1b" stopOpacity="0" />
            </radialGradient>
          </defs>
